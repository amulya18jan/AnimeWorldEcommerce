...
const Home = (props) => {
    ...
    useEffect(() => {
        let t = temp.filter((i) => i.category == "Mobile BackCovers");
        let  t1=t.slice(0,10);
    ...
    useEffect(() => {
        let t = temp.filter((i) => i.category == "Anime Statue");
        let  t1=t.slice(0,20);
    ...
    return (
        <div className="Home_page">
            ...
            <div className="pro_slider2_container pro_slider_container">
                <Productslider title="Mobile BackCovers" id="scroll2" data={proList_Mobile} />
            </div>

            <div className="pro_slider3_container pro_slider_container">
                <Productslider title="Anime Statue" id="scroll3" data={proList_Grocery} />
            </div>
